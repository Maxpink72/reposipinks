...
import type { TResponsePipelineJobData, TSurveySchedulingJobData, TTestLogJobData, TResearchExportPdfJobData, TResearchExportXlsxJobData } from "@/src/types";
...
export interface BackgroundJobProducer {
  ...
  enqueueResearchExportPdf: (data: TResearchExportPdfJobData) => Promise<EnqueuedJob>;
  enqueueResearchExportXlsx: (data: TResearchExportXlsxJobData) => Promise<EnqueuedJob>;
