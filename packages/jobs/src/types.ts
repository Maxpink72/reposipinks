...
export const ZResearchExportPdfJobData = z.object({
  exportJobId: z.string().min(1),
});

export type TResearchExportPdfJobData = z.infer<typeof ZResearchExportPdfJobData>;

export const ZResearchExportXlsxJobData = z.object({
  exportJobId: z.string().min(1),
});

export type TResearchExportXlsxJobData = z.infer<typeof ZResearchExportXlsxJobData>;
