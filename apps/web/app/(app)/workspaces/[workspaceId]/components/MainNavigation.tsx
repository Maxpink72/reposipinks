...
interface NavigationProps {
  ...
  isResearchPlatformEnabled: boolean;
}
...
export const MainNavigation = ({
  ...
  const mainNavigationSections = useMemo(
    () => [
      ...
      ...(isResearchPlatformEnabled
        ? [
            {
              id: "research",
              name: t("research.nav_section"),
              items: [
                {
                  name: t("research.title"),
                  href: `/workspaces/${workspace.id}/research`,
                  icon: FoldersIcon,
                  isActive: pathname?.includes("/research"),
                  isHidden: false,
                  disabled: isMembershipPending || isBilling,
                },
              ],
    ...
    [t, workspace.id, pathname, isMembershipPending, isBilling, isResearchPlatformEnabled]
  );
